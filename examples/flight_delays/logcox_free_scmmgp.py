# -*- coding: utf-8 -*-
"""
Script to execute example free sparse covarying MMGP with Poisson likelihood and
freely parameterized (sparse) cross function covariance Krhh.
The free model invokes the 'free' sparse model class.
...
Current Settings (free scmmgp model with sparse Kronecker posterior):
    DIAG_POST = False
    SPARSE_PRIOR = True  # set False for equivalent non-sparse model
    SPARSE_POST = True
...
outdir = '/experiments/results/logcox_free_scmmgp'
